            ...
            <div className='block-container w-20 h-20' key={skill.name}>
              ...
              <div className='btn-front rounded-xl flex justify-center items-center'>
                <div className="relative group w-full h-full flex justify-center items-center">
                  ...
                  />
                  <div className="absolute bottom-0 mb-2 px-2 py-1 text-xs text-white bg-black bg-opacity-70 rounded opacity-0 group-hover:opacity-100 transition duration-200 pointer-events-none">
                    {skill.name}
                  </div>
                </div>
              </div>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>
            ...
            teamwork, and creativity. Here’s the journey so far:
          </p>
        </div>
